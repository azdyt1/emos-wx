<template>
		<view class="page">
			...
			<uni-list>
				...
				<uni-list-item title="我的考勤" link to="/checkin/my_checkin"></uni-list-item>
				<uni-list-item title="罚款记录" link to=""></uni-list-item>
			</uni-list>
			<view class="list-title">系统管理栏目</view>
			<uni-list>
				<uni-list-item title="员工管理" v-show="checkPermission(['ROOT', 'EMPLOYEE:SELECT'])" link to="../../user/user_list"></uni-list-item>
